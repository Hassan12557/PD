            ...
            {selectedMessage === message.id ? (
              <div className="mt-3 space-y-2">
                ...
                <div className="flex flex-wrap space-x-2">
                  <button
                    onClick={() => handleReply(message.id)}
                    className="bg-purple-600 text-white px-4 py-2 rounded-md text-sm hover:bg-purple-700 flex items-center space-x-1 mb-2 sm:mb-0"
                  >
                    <Send size={14} />
                    <span>Send Reply</span>
                  </button>
              ...
              <div className="mt-2 flex flex-wrap space-x-3">
                <button
                  ...
                  className="text-sm text-purple-600 hover:text-purple-700 flex items-center space-x-1 mb-2 sm:mb-0"
                >
                  <Send size={14} />
                  <span>Reply</span>
                </button>
