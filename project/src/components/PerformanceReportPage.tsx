...
const EmotionalReportPage = () => {
  const emotions = [
    { day: 'Monday', emotion: 'Happy' },
    { day: 'Tuesday', emotion: 'Sad' },
    { day: 'Wednesday', emotion: 'Excited' },
    { day: 'Thursday', emotion: 'Angry' },
    { day: 'Friday', emotion: 'Calm' },
  ];

  return (
    <div className="bg-white p-4 sm:p-6 rounded-xl shadow-md w-full">
      <h2 className="text-xl sm:text-2xl font-semibold mb-4">Emotional Report</h2>
