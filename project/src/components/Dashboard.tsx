...
const Dashboard: React.FC<DashboardProps> = ({ childName }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Top Bar */}
      <div className="bg-white h-16 fixed top-0 right-0 left-0 sm:left-64 px-8 flex items-center justify-between shadow-sm z-10">
        <div>
          <h1 className="text-xl font-semibold text-gray-800">Hello, Parent!</h1>
          <p className="text-sm text-gray-600">Viewing {childName}'s Progress</p>
        </div>
      ...
      {/* Main Content */}
      <div className="pt-20 px-4 sm:px-8 pb-8 sm:ml-64">
